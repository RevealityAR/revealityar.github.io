...
export default function emailListForm({ uniqueId, mailchimpURL, uniqueAntiSpamId }: OwnProps) {
  ...
  <div style={{position: 'absolute', left: '-5000px'}} aria-hidden="true">
    <TextField type="text" name={uniqueAntiSpamId} value="true"/>
        ...
        <IconButton 
        type="submit" 
        sx={{ width: '4rem', marginLeft: '0.5rem', backgroundColor: theme.palette.primary.main, borderRadius: '4px', color: 'white', 'svg': {transition: 'all 100ms linear'}, '&:hover': { backgroundColor: theme.palette.secondary.main, 'svg': {transform: 'scale(1.15)'} } }} 
        name="subscribe" 
        value= "Subscribe"
