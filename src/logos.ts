...
import logoCiteSciences from './res/logoClient_carrnum.png'
import logoUniv from './res/logoClient_univLyon1.png'
import logoUniv2 from './res/logoParisNanterre.png'
...
export const EDUCATION_LOGOS = [
  ...
  { imageUrl: logoClient_saintex, siteUrl: 'https://saintex-reims.com/' },
  { imageUrl: logoClient_snzc, siteUrl: 'https://en.snzn.org/' },
  { imageUrl: logoCiteSciences, siteUrl: 'https://www.cite-sciences.fr/' },
  { imageUrl: logoUniv, siteUrl: 'https://www.universite-lyon.fr/' },
  { imageUrl: logoUniv2, siteUrl: 'https://www.parisnanterre.fr/' },
]
